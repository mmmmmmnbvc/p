...
if (isset($_SESSION["username"])) {
    ...
    if ($row) {
        ...
        echo "<br>\n";
        echo "<br>\n";
        echo "<a class='Register' href='editUser.php?username=" . htmlspecialchars($row["username"]) . "'>แก้ไข</a> <br>";
        
        echo "<br>\n";
        echo "<br>\n";
        echo "<a class='Register' href='logout.php?username=" . htmlspecialchars($row["username"]) . "'>ออกจากระบบ</a> <br>";
        echo "<br>\n";
        echo "<br>\n";
