...
$qr_data = "สั่งซื้อสำเร็จ"; 
$qr_url = "https://api.qrserver.com/v1/create-qr-code/?data=" . urlencode($qr_data) . "&size=200x200"; //api
?>
<!doctype html>
<html lang="en">
...
<nav>
    <h3>
      ...
      <section class="h">
      <h1 >ชำระเงิน</h1>
    <p>จำนวนเงิน: <?php echo htmlspecialchars($amount); ?> บาท</p>
    <img src="<?php echo htmlspecialchars($qr_url); ?>" alt="QR Code สำหรับการชำระเงิน">
    <p>เวลานับถอยหลัง: <span id="countdown">30 วินาที</span></p>
