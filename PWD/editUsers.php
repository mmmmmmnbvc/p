...
<nav>
    ...
    <a href="food.php"> อาหาร</a>
      ...
      <article>
      <?php
$stmt = $pdo->prepare("UPDATE User_PCK SET name_cus = ?, suname_cus = ?,address = ?, phonenumber = ?, email = ? WHERE username = ?");


$stmt->bindParam(1, $_POST["username"]); 
$stmt->bindParam(2, $_POST["name_cus"]);
$stmt->bindParam(3, $_POST["suname_cus"]);
...
if ($stmt->execute()) {
    echo "แก้ไขสมาชิก " . htmlspecialchars($_POST["name_cus"]) . " สำเร็จ";
} else {
